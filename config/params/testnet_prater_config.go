...
func PraterConfig() *BeaconChainConfig {
	...
	cfg.FastexPhase1ForkEpoch = 162304
	cfg.FastexPhase1ForkVersion = []byte{0x3, 0x0, 0x10, 0x20}
	cfg.CapellaForkEpoch = 162404
	cfg.CapellaForkVersion = []byte{0x4, 0x0, 0x10, 0x20}
