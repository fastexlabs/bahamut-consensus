...
type BeaconChainConfig struct {
	...
	EpochsPerActivityPeriod types.Epoch `yaml:"EPOCHS_PER_ACTIVITY_PERIOD"` // EpochsPerActivityPeriod is the number of epochs that is used in effective activity calculation.
	EpochsPerAcrivityUpdate types.Epoch `yaml:"EPOCHS_PER_ACTIVITY_UPDATE"` // EpochsPerActivityUpdate is the number of epochs between effective activity updates.
