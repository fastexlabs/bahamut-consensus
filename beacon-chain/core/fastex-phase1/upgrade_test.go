...
func TestUpgradeToFastex(t *testing.T) {
	...
	require.DeepSSZEqual(t, preForkState.LatestProcessedBlockActivities(), mSt.LatestProcessedBlockActivities())
	require.DeepSSZEqual(t, preForkState.NonStakersGasPerEpoch(), mSt.NonStakersGasPerEpoch())
	require.DeepSSZEqual(t, preForkState.NonStakersGasPerPeriod(), mSt.NonStakersGasPerPeriod())
	require.DeepSSZEqual(t, preForkState.TransactionsPerLatestEpoch(), mSt.TransactionsPerLatestEpoch())
	require.DeepSSZEqual(t, preForkState.TransactionsGasPerPeriod(), mSt.TransactionsGasPerPeriod())
	require.DeepSSZEqual(t, preForkState.Validators(), mSt.Validators())
	require.DeepSSZEqual(t, preForkState.Balances(), mSt.Balances())
	require.DeepSSZEqual(t, preForkState.Contracts(), mSt.Contracts())
