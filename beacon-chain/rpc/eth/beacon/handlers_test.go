...
func TestServer_GetBlockHeader(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		assert.Equal(t, "0xb26c269153ec22fde337c146d14ae3f67f8e1c5345e78b6425d59a6067435e38", resp.Data.Root)
		...
		assert.Equal(t, "0x3ff6e44fef223dcc8f87831b8d1f88ab6db9494fc5f1f9aa97b1abf42933f469", resp.Data.Header.Message.BodyRoot)
