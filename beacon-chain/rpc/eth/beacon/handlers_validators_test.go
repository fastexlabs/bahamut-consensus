...
func TestGetValidators(t *testing.T) {
	...
	t.Run("get all", func(t *testing.T) {
		...
		assert.Equal(t, "8192000000000", val.Balance)
		...
		assert.Equal(t, "8192000000000", val.Validator.EffectiveBalance)
...
func TestListValidators_FilterByStatus(t *testing.T) {
	...
	for _, val := range validators {
		...
		require.NoError(t, st.AppendActivity(0))
	}
...
func TestGetValidator(t *testing.T) {
	...
	t.Run("get by index", func(t *testing.T) {
		...
		assert.Equal(t, "8192000000000", resp.Data.Balance)
		...
		assert.Equal(t, "8192000000000", resp.Data.Validator.EffectiveBalance)
