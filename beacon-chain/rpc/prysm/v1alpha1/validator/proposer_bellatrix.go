...
func (vs *Server) getBellatrixBeaconBlock(ctx context.Context, req *ethpb.BlockRequest) (*ethpb.GenericBeaconBlock, error) {
	...
	blk := &ethpb.BeaconBlockBellatrix{
		...
		Body: &ethpb.BeaconBlockBodyBellatrix{
			...
			ActivityChanges:      altairBlk.Body.ActivityChanges,
			LatestProcessedBlock: altairBlk.Body.LatestProcessedBlock,
			TransactionsCount:    altairBlk.Body.TransactionsCount,
	...
	bb := &ethpb.SignedBeaconBlockBellatrix{
		Block: &ethpb.BeaconBlockBellatrix{
			...
			Body: &ethpb.BeaconBlockBodyBellatrix{
				...
				LatestProcessedBlock: sb.Block.Body.LatestProcessedBlock,
