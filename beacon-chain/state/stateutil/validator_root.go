...
func ValidatorFieldRoots(hasher ssz.HashFn, validator *ethpb.Validator) ([][32]byte, error) {
	...
	if validator != nil {
		...
		effectiveActivityBuf := [32]byte{}
		binary.LittleEndian.PutUint64(effectiveActivityBuf[:8], validator.EffectiveActivity)
		// Slashed.
		...
		fieldRoots = [][32]byte{pubKeyRoot, withdrawCreds, effectiveBalanceBuf, effectiveActivityBuf, slashBuf, activationEligibilityBuf,
			activationBuf, exitBuf, withdrawalBuf, [32]byte{}, [32]byte{}, [32]byte{}, [32]byte{}, [32]byte{}, [32]byte{}, [32]byte{}}
	}
