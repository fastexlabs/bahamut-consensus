...
func TestComputeFieldRootsWithHasher_Phase0(t *testing.T) {
	...
	require.NoError(t, beaconState.SetSharedActivity(shareedActivity()))
	...
	require.NoError(t, beaconState.SetActivities([]uint64{1, 2, 3}))
	...
	expected := [][]byte{
		...
		{0x7b, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
		{0xbf, 0xe3, 0xc6, 0x65, 0xd2, 0xe5, 0x61, 0xf1, 0x3b, 0x30, 0x60, 0x6c, 0x58, 0xc, 0xb7, 0x3, 0xb2, 0x4, 0x12, 0x87, 0xe2, 0x12, 0xad, 0xe1, 0x10, 0xf0, 0xbf, 0xd8, 0x56, 0x3e, 0x21, 0xbb},
		{0x86, 0xda, 0x81, 0x7d, 0x68, 0x96, 0x32, 0xb, 0x6e, 0x74, 0x56, 0x82, 0x33, 0xa4, 0xf3, 0x89, 0x95, 0xee, 0xcb, 0xf, 0xe7, 0x21, 0xbc, 0x46, 0x5c, 0xa2, 0xde, 0x2a, 0x31, 0x43, 0x10, 0xe1},
...
func TestComputeFieldRootsWithHasher_Capella(t *testing.T) {
	...
	expected := [][]byte{
		...
		{0x3d, 0xf3, 0x66, 0xd4, 0x12, 0x40, 0x3f, 0x28, 0xeb, 0xe4, 0x19, 0x59, 0xae, 0xab, 0x4d, 0xf3, 0x98, 0x88, 0x7f, 0x1e, 0x58, 0xa, 0x5d, 0xd4, 0xeb, 0xe5, 0x5d, 0x3d, 0x11, 0x70, 0x24, 0x76},
		{0xd6, 0x4c, 0xb1, 0xac, 0x61, 0x7, 0x26, 0xbb, 0xd3, 0x27, 0x2a, 0xcd, 0xdd, 0x55, 0xf, 0x2b, 0x6a, 0xe8, 0x1, 0x31, 0x48, 0x66, 0x2f, 0x98, 0x7b, 0x6d, 0x27, 0x69, 0xd9, 0x40, 0xcc, 0x37},
		{0xd9, 0x18, 0x31, 0x9a, 0x37, 0x5f, 0x4a, 0xb0, 0x2b, 0x5, 0xc5, 0x94, 0xfc, 0xf5, 0xbc, 0x34, 0x95, 0x1c, 0x33, 0x21, 0x74, 0xc, 0x29, 0x92, 0x8a, 0xf8, 0xed, 0xce, 0x22, 0x69, 0x48, 0x58},
		{0x7b, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
		{0x7b, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
...
func shareedActivity() *ethpb.SharedActivity {
	return &ethpb.SharedActivity{
		TransactionsGasPerPeriod: 1,
		TransactionsGasPerEpoch:  2,
		BaseFeePerPeriod:         3,
		BaseFeePerEpoch:          4,
	}
}
...
func validator() *ethpb.Validator {
	...
	ctr := bytesutil.ToBytes20([]byte("contract"))
	return &ethpb.Validator{
		PublicKey:                  pk[:],
		WithdrawalCredentials:      wc[:],
		Contract:                   ctr[:],
		EffectiveBalance:           123,
		EffectiveActivity:          123,
		Slashed:                    true,
...
func executionPayloadHeaderCapella() *enginev1.ExecutionPayloadHeaderCapella {
	...
	ar := bytesutil.ToBytes32([]byte("activities"))
