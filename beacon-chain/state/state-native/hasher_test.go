...
func TestComputeFieldRootsWithHasher_Phase0(t *testing.T) {
	...
	require.NoError(t, beaconState.SetContracts([]*ethpb.ContractsContainer{contracts()}))
	...
	expected := [][]byte{
		...
		{0xa9, 0xfb, 0xf7, 0x0f, 0xe4, 0x26, 0xdd, 0x37, 0x74, 0xba, 0xb6, 0x8c, 0x5e, 0x2b, 0xf8, 0x7a, 0x24, 0xf0, 0x9f, 0x50, 0xe1, 0xc1, 0x00, 0x65, 0xc6, 0x78, 0x90, 0x06, 0xae, 0x96, 0xf9, 0xb7},
...
func contracts() *ethpb.ContractsContainer {
	return &ethpb.ContractsContainer{
		Contracts: [][]byte{
