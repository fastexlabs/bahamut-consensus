...
type beaconStateMarshalable struct {
	...
	SharedActivity                      *ethpb.SharedActivity                   `json:"shared_activity" yaml:"shared_activity"`
	Validators                          []*ethpb.Validator                      `json:"validators" yaml:"validators"`
	Balances                            []uint64                                `json:"balances" yaml:"balances"`
	Activities                          []uint64                                `json:"activities" yaml:"activities"`
...
func (b *BeaconState) MarshalJSON() ([]byte, error) {
	...
	marshalable := &beaconStateMarshalable{
		...
		SharedActivity:                      b.sharedActivity,
		Validators:                          vals,
		Balances:                            balances,
