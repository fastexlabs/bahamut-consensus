...
type BeaconState struct {
	...
	latestProcessedBlockActivities uint64                           `ssz-gen:"true"`
	transactionsGasPerPeriod       uint64                           `ssz-gen:"true"`
	transactionsPerLatestEpoch     uint64                           `ssz-gen:"true"`
	nonStakersGasPerEpoch          uint64                           `ssz-gen:"true"`
	nonStakersGasPerPeriod         uint64                           `ssz-gen:"true"`
	validators                     []*ethpb.Validator               `ssz-gen:"true" ssz-max:"1099511627776"`
	balances                       []uint64                         `ssz-gen:"true" ssz-max:"1099511627776"`
	contracts                      []*ethpb.ContractsContainer      `ssz-gen:"true" ssz-max:"1099511627776"`
	activities                     []uint64                         `ssz-gen:"true" ssz-max:"1099511627776"`
