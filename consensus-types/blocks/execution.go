...
// ActivitiesRoot --
func (e executionPayload) ActivitiesRoot() ([]byte, error) {
	return nil, consensus_types.ErrUnsupportedField
}

// TransactionsCount --
func (e executionPayload) TransactionsCount() (uint64, error) {
...
// ActivitiesRoot --
func (e executionPayloadHeader) ActivitiesRoot() ([]byte, error) {
	return nil, consensus_types.ErrUnsupportedField
}

// TransactionsCount --
func (e executionPayloadHeader) TransactionsCount() (uint64, error) {
	return 0, consensus_types.ErrUnsupportedField
}
...
// ActivitiesRoot --
func (e executionPayloadCapella) ActivitiesRoot() ([]byte, error) {
	return e.p.ActivitiesRoot, nil
}

// TransactionsCount --
func (e executionPayloadCapella) TransactionsCount() (uint64, error) {
	return e.p.TransactionsCount, nil
}
...
// ActivitiesRoot --
func (e executionPayloadHeaderCapella) ActivitiesRoot() ([]byte, error) {
	return e.p.ActivitiesRoot, nil
}

// TransactionsCount --
func (e executionPayloadHeaderCapella) TransactionsCount() (uint64, error) {
	return e.p.TransactionsCount, nil
}
...
func PayloadToHeaderCapella(payload interfaces.ExecutionData) (*enginev1.ExecutionPayloadHeaderCapella, error) {
	...
	act, err := payload.ActivitiesRoot()
	if err != nil {
		return nil, err
	}
	txsCount, err := payload.TransactionsCount()
	if err != nil {
		return nil, err
	}
	...
	return &enginev1.ExecutionPayloadHeaderCapella{
		...
		StateRoot:         bytesutil.SafeCopyBytes(payload.StateRoot()),
		ReceiptsRoot:      bytesutil.SafeCopyBytes(payload.ReceiptsRoot()),
		ActivitiesRoot:    bytesutil.SafeCopyBytes(act),
...
func IsEmptyActivityChanges(data interfaces.ExecutionData) (bool, error) {
	actRoot, err := data.ActivitiesRoot()
	if err != nil {
		return false, err
	}
	if !bytes.Equal(actRoot, make([]byte, fieldparams.RootLength)) {
		return false, nil
	}
	txCount, err := data.TransactionsCount()
	if err != nil {
		return false, err
	}
	if txCount != 0 {
...
// ActivitiesRoot --
func (e executionPayloadHeaderDeneb) ActivitiesRoot() ([]byte, error) {
	return e.p.ActivitiesRoot, nil
}

// TransactionsCount --
func (e executionPayloadHeaderDeneb) TransactionsCount() (uint64, error) {
	return e.p.TransactionsCount, nil
}
...
// ActivitiesRoot --
func (e executionPayloadDeneb) ActivitiesRoot() ([]byte, error) {
	return e.p.ActivitiesRoot, nil
}

// TransactionsCount --
func (e executionPayloadDeneb) TransactionsCount() (uint64, error) {
	return e.p.TransactionsCount, nil
}
