...
// Hash: 743abc694202cf9335d85518f0262530983b011494c046ade5fdf7414f14b103
package eth
...
func (b *BeaconBlockBody) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (9) 'TransactionsCount'
	dst = ssz.MarshalUint64(dst, b.TransactionsCount)

	// Field (10) 'BaseFee'
	dst = ssz.MarshalUint64(dst, b.BaseFee)

	// Field (11) 'ExecutionHeight'
	dst = ssz.MarshalUint64(dst, b.ExecutionHeight)
	...
	if size := len(b.ActivityChanges); size > 1073741824 {
		err = ssz.ErrListTooBigFn("--.ActivityChanges", size, 1073741824)
		return
	}
...
func (b *BeaconBlockBody) UnmarshalSSZ(buf []byte) error {
	...
	// Field (9) 'TransactionsCount'
	b.TransactionsCount = ssz.UnmarshallUint64(buf[224:232])

	// Field (10) 'BaseFee'
	b.BaseFee = ssz.UnmarshallUint64(buf[232:240])

	// Field (11) 'ExecutionHeight'
	b.ExecutionHeight = ssz.UnmarshallUint64(buf[240:248])
	...
	{
		buf = tail[o6:o7]
		num, err := ssz.DivideInt2(len(buf), 1260, 16)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Deposits[ii].UnmarshalSSZ(buf[ii*1260 : (ii+1)*1260]); err != nil {
				return err
			}
		}
	}
	...
	{
		buf = tail[o8:]
		num, err := ssz.DivideInt2(len(buf), 28, 1073741824)
		if err != nil {
			return err
		}
...
func (b *BeaconBlockBody) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (8) 'ActivityChanges'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, num, 1073741824)
		} else {
	...
	// Field (11) 'ExecutionHeight'
	hh.PutUint64(b.ExecutionHeight)
...
func (b *BeaconBlockBodyAltair) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.SyncAggregate.UnmarshalSSZ(buf[248:408]); err != nil {
		return err
	}
...
func (d *Deposit) UnmarshalSSZ(buf []byte) error {
	...
	if err = d.Data.UnmarshalSSZ(buf[1056:1260]); err != nil {
		return err
	}
...
func (b *BeaconBlockBodyBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o3, o4, o5, o6, o7, o8, o13 uint64
	...
	// Offset (13) 'ExecutionPayload'
	if o13 = ssz.ReadOffset(buf[408:412]); o13 > size || o8 > o13 {
		return ssz.ErrOffset
	}
...
func (b *BlindedBeaconBlockBodyBellatrix) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (13) 'ExecutionPayloadHeader'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (13) 'ExecutionPayloadHeader'
...
func (b *BeaconBlockBodyCapella) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o3, o4, o5, o6, o7, o8, o13, o14 uint64
	...
	// Offset (14) 'BlsToExecutionChanges'
	if o14 = ssz.ReadOffset(buf[412:416]); o14 > size || o13 > o14 {
		return ssz.ErrOffset
	}
...
func (d *Deposit_Data) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Contract'
	if size := len(d.Contract); size != 20 {
		err = ssz.ErrBytesLengthFn("--.Contract", size, 20)
		return
	}
	dst = append(dst, d.Contract...)
...
func (d *Deposit_Data) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Contract'
	if cap(d.Contract) == 0 {
		d.Contract = make([]byte, 0, len(buf[80:100]))
	}
	d.Contract = append(d.Contract, buf[80:100]...)

	// Field (3) 'Amount'
	d.Amount = ssz.UnmarshallUint64(buf[100:108])

	// Field (4) 'Signature'
	if cap(d.Signature) == 0 {
		d.Signature = make([]byte, 0, len(buf[108:204]))
	}
	d.Signature = append(d.Signature, buf[108:204]...)
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (11) 'SharedActivity'
	if b.SharedActivity == nil {
		b.SharedActivity = new(SharedActivity)
	}
	if dst, err = b.SharedActivity.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (12) 'ExecutionHeight'
	dst = ssz.MarshalUint64(dst, b.ExecutionHeight)

	// Offset (13) 'Validators'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.Validators) * 149

	// Offset (14) 'Balances'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.Balances) * 8

	// Offset (15) 'Activities'
	dst = ssz.WriteOffset(dst, offset)
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o13, o14, o15, o18, o19 uint64
	...
	if err = b.SharedActivity.UnmarshalSSZ(buf[524552:524584]); err != nil {
		return err
	}

	// Field (12) 'ExecutionHeight'
	b.ExecutionHeight = ssz.UnmarshallUint64(buf[524584:524592])

	// Offset (13) 'Validators'
	if o13 = ssz.ReadOffset(buf[524592:524596]); o13 > size || o9 > o13 {
		return ssz.ErrOffset
	}

	// Offset (14) 'Balances'
	if o14 = ssz.ReadOffset(buf[524596:524600]); o14 > size || o13 > o14 {
		return ssz.ErrOffset
	}

	// Offset (15) 'Activities'
	if o15 = ssz.ReadOffset(buf[524600:524604]); o15 > size || o14 > o15 {
		return ssz.ErrOffset
	}
	...
	for ii := 0; ii < 65536; ii++ {
		if cap(b.RandaoMixes[ii]) == 0 {
			b.RandaoMixes[ii] = make([]byte, 0, len(buf[524604:2621756][ii*32:(ii+1)*32]))
		}
		b.RandaoMixes[ii] = append(b.RandaoMixes[ii], buf[524604:2621756][ii*32:(ii+1)*32]...)
	}

	// Field (17) 'Slashings'
	b.Slashings = ssz.ExtendUint64(b.Slashings, 8192)
	for ii := 0; ii < 8192; ii++ {
		b.Slashings[ii] = ssz.UnmarshallUint64(buf[2621756:2687292][ii*8 : (ii+1)*8])
	}

	// Offset (18) 'PreviousEpochAttestations'
	if o18 = ssz.ReadOffset(buf[2687292:2687296]); o18 > size || o15 > o18 {
		return ssz.ErrOffset
	}

	// Offset (19) 'CurrentEpochAttestations'
	if o19 = ssz.ReadOffset(buf[2687296:2687300]); o19 > size || o18 > o19 {
		return ssz.ErrOffset
	}

	// Field (20) 'JustificationBits'
	if cap(b.JustificationBits) == 0 {
		b.JustificationBits = make([]byte, 0, len(buf[2687300:2687301]))
	}
	b.JustificationBits = append(b.JustificationBits, buf[2687300:2687301]...)

	// Field (21) 'PreviousJustifiedCheckpoint'
	if b.PreviousJustifiedCheckpoint == nil {
		b.PreviousJustifiedCheckpoint = new(Checkpoint)
	}
	if err = b.PreviousJustifiedCheckpoint.UnmarshalSSZ(buf[2687301:2687341]); err != nil {
		return err
	}
	...
	if err = b.CurrentJustifiedCheckpoint.UnmarshalSSZ(buf[2687341:2687381]); err != nil {
		return err
	}
	...
	if err = b.FinalizedCheckpoint.UnmarshalSSZ(buf[2687381:2687421]); err != nil {
		return err
	}
	...
	{
		buf = tail[o13:o14]
		num, err := ssz.DivideInt2(len(buf), 149, 1099511627776)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Validators[ii].UnmarshalSSZ(buf[ii*149 : (ii+1)*149]); err != nil {
				return err
			}
		}
	}
...
func (b *BeaconState) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (11) 'SharedActivity'
	if err = b.SharedActivity.HashTreeRootWith(hh); err != nil {
		return
	}
...
func (b *BeaconStateAltair) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o13, o14, o15, o18, o19, o24 uint64
	...
	// Offset (24) 'InactivityScores'
	if o24 = ssz.ReadOffset(buf[2687421:2687425]); o24 > size || o19 > o24 {
		return ssz.ErrOffset
	}
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2687425:2712049]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2712049:2736673]); err != nil {
		return err
	}
...
// MarshalSSZ ssz marshals the SharedActivity object
func (s *SharedActivity) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SharedActivity object to a target array
func (s *SharedActivity) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	// Field (0) 'TransactionsGasPerPeriod'
	dst = ssz.MarshalUint64(dst, s.TransactionsGasPerPeriod)

	// Field (1) 'TransactionsGasPerEpoch'
	dst = ssz.MarshalUint64(dst, s.TransactionsGasPerEpoch)

	// Field (2) 'BaseFeePerPeriod'
	dst = ssz.MarshalUint64(dst, s.BaseFeePerPeriod)

	// Field (3) 'BaseFeePerEpoch'
	dst = ssz.MarshalUint64(dst, s.BaseFeePerEpoch)

	return
}

// UnmarshalSSZ ssz unmarshals the SharedActivity object
func (s *SharedActivity) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 32 {
		return ssz.ErrSize
	...
	// Field (0) 'TransactionsGasPerPeriod'
	s.TransactionsGasPerPeriod = ssz.UnmarshallUint64(buf[0:8])

	// Field (1) 'TransactionsGasPerEpoch'
	s.TransactionsGasPerEpoch = ssz.UnmarshallUint64(buf[8:16])

	// Field (2) 'BaseFeePerPeriod'
	s.BaseFeePerPeriod = ssz.UnmarshallUint64(buf[16:24])

	// Field (3) 'BaseFeePerEpoch'
	s.BaseFeePerEpoch = ssz.UnmarshallUint64(buf[24:32])

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the SharedActivity object
func (s *SharedActivity) SizeSSZ() (size int) {
	size = 32
	return
}

// HashTreeRoot ssz hashes the SharedActivity object
func (s *SharedActivity) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SharedActivity object with a hasher
func (s *SharedActivity) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'TransactionsGasPerPeriod'
	hh.PutUint64(s.TransactionsGasPerPeriod)

	// Field (1) 'TransactionsGasPerEpoch'
	hh.PutUint64(s.TransactionsGasPerEpoch)

	// Field (2) 'BaseFeePerPeriod'
	hh.PutUint64(s.BaseFeePerPeriod)

	// Field (3) 'BaseFeePerEpoch'
	hh.PutUint64(s.BaseFeePerEpoch)
...
func (b *BeaconStateBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o13, o14, o15, o18, o19, o24, o27 uint64
	...
	// Offset (27) 'LatestExecutionPayloadHeader'
	if o27 = ssz.ReadOffset(buf[2736673:2736677]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateCapella) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o13, o14, o15, o18, o19, o24, o27, o30 uint64
	...
	// Field (28) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2736677:2736685])

	// Field (29) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2736685:2736693]))

	// Offset (30) 'HistoricalSummaries'
	if o30 = ssz.ReadOffset(buf[2736693:2736697]); o30 > size || o27 > o30 {
		return ssz.ErrOffset
	}
...
func (v *Validator) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Contract'
	if size := len(v.Contract); size != 20 {
		err = ssz.ErrBytesLengthFn("--.Contract", size, 20)
		return
	}
	dst = append(dst, v.Contract...)

	// Field (3) 'EffectiveBalance'
	dst = ssz.MarshalUint64(dst, v.EffectiveBalance)

	// Field (4) 'EffectiveActivity'
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Contract'
	if cap(v.Contract) == 0 {
		v.Contract = make([]byte, 0, len(buf[80:100]))
	}
	v.Contract = append(v.Contract, buf[80:100]...)

	// Field (3) 'EffectiveBalance'
	v.EffectiveBalance = ssz.UnmarshallUint64(buf[100:108])

	// Field (4) 'EffectiveActivity'
	v.EffectiveActivity = ssz.UnmarshallUint64(buf[108:116])

	// Field (5) 'Slashed'
	v.Slashed = ssz.UnmarshalBool(buf[116:117])

	// Field (6) 'ActivationEligibilityEpoch'
	v.ActivationEligibilityEpoch = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[117:125]))

	// Field (7) 'ActivationEpoch'
	v.ActivationEpoch = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[125:133]))

	// Field (8) 'ExitEpoch'
	v.ExitEpoch = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[133:141]))

	// Field (9) 'WithdrawableEpoch'
	v.WithdrawableEpoch = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[141:149]))
