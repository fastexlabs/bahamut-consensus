...
// Hash: 74e82b396d2d62281512850afd32026da7cc84530c31ce0ad4d626e37e32255e
package eth
...
func (b *BeaconBlockBody) UnmarshalSSZ(buf []byte) error {
	...
	// Field (8) 'ActivityChanges'
	{
		...
		b.ActivityChanges = make([]*ActivityChange, num)
		for ii := 0; ii < num; ii++ {
			if b.ActivityChanges[ii] == nil {
				b.ActivityChanges[ii] = new(ActivityChange)
			}
...
func (d *Deposit) UnmarshalSSZ(buf []byte) error {
	...
	if err = d.Data.UnmarshalSSZ(buf[1056:1268]); err != nil {
		return err
	}
...
// MarshalSSZ ssz marshals the ActivityChange object
func (a *ActivityChange) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(a)
}

// MarshalSSZTo ssz marshals the ActivityChange object to a target array
func (a *ActivityChange) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	// Field (0) 'ContractAddress'
	if size := len(a.ContractAddress); size != 20 {
		err = ssz.ErrBytesLengthFn("--.ContractAddress", size, 20)
		return
	}
	dst = append(dst, a.ContractAddress...)

	// Field (1) 'DeltaActivity'
	dst = ssz.MarshalUint64(dst, a.DeltaActivity)

	return
}

// UnmarshalSSZ ssz unmarshals the ActivityChange object
func (a *ActivityChange) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 28 {
		return ssz.ErrSize
	...
	// Field (0) 'ContractAddress'
	if cap(a.ContractAddress) == 0 {
		a.ContractAddress = make([]byte, 0, len(buf[0:20]))
	}
	a.ContractAddress = append(a.ContractAddress, buf[0:20]...)

	// Field (1) 'DeltaActivity'
	a.DeltaActivity = ssz.UnmarshallUint64(buf[20:28])

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the ActivityChange object
func (a *ActivityChange) SizeSSZ() (size int) {
	size = 28
	return
}

// HashTreeRoot ssz hashes the ActivityChange object
func (a *ActivityChange) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(a)
}

// HashTreeRootWith ssz hashes the ActivityChange object with a hasher
func (a *ActivityChange) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	hh.PutBytes(a.ContractAddress)

	// Field (1) 'DeltaActivity'
	hh.PutUint64(a.DeltaActivity)
...
func (s *SignedBeaconBlockFastexPhase1) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Block == nil {
		s.Block = new(BeaconBlockFastexPhase1)
	}
	offset += s.Block.SizeSSZ()
...
func (s *SignedBlindedBeaconBlockFastexPhase1) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Block == nil {
		s.Block = new(BlindedBeaconBlockFastexPhase1)
	}
	offset += s.Block.SizeSSZ()
...
func (d *Deposit_Data) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (4) 'DeployedContract'
	if size := len(d.DeployedContract); size != 20 {
		err = ssz.ErrBytesLengthFn("--.DeployedContract", size, 20)
		return
	}
	dst = append(dst, d.DeployedContract...)

	// Field (5) 'DeploymentNonce'
	dst = ssz.MarshalUint64(dst, d.DeploymentNonce)
...
func (d *Deposit_Data) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'DeployedContract'
	if cap(d.DeployedContract) == 0 {
		d.DeployedContract = make([]byte, 0, len(buf[184:204]))
	}
	d.DeployedContract = append(d.DeployedContract, buf[184:204]...)

	// Field (5) 'DeploymentNonce'
	d.DeploymentNonce = ssz.UnmarshallUint64(buf[204:212])
...
func (d *Deposit_Data) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	hh.PutBytes(d.DeployedContract)

	// Field (5) 'DeploymentNonce'
	hh.PutUint64(d.DeploymentNonce)
...
// MarshalSSZ ssz marshals the ContractsContainer object
func (c *ContractsContainer) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(c)
}

// MarshalSSZTo ssz marshals the ContractsContainer object to a target array
func (c *ContractsContainer) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(4)

	// Offset (0) 'Contracts'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(c.Contracts) * 20

	// Field (0) 'Contracts'
	if size := len(c.Contracts); size > 1099511627776 {
		err = ssz.ErrListTooBigFn("--.Contracts", size, 1099511627776)
		return
	}
	for ii := 0; ii < len(c.Contracts); ii++ {
		if size := len(c.Contracts[ii]); size != 20 {
			err = ssz.ErrBytesLengthFn("--.Contracts[ii]", size, 20)
			return
		}
		dst = append(dst, c.Contracts[ii]...)
	}

	return
}

// UnmarshalSSZ ssz unmarshals the ContractsContainer object
func (c *ContractsContainer) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 4 {
		return ssz.ErrSize
	...
	{
		buf = tail[o0:]
		num, err := ssz.DivideInt2(len(buf), 20, 1099511627776)
		if err != nil {
			return err
		}
		c.Contracts = make([][]byte, num)
		for ii := 0; ii < num; ii++ {
			if cap(c.Contracts[ii]) == 0 {
				c.Contracts[ii] = make([]byte, 0, len(buf[ii*20:(ii+1)*20]))
			}
			c.Contracts[ii] = append(c.Contracts[ii], buf[ii*20:(ii+1)*20]...)
		}
	}
	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the ContractsContainer object
func (c *ContractsContainer) SizeSSZ() (size int) {
	size = 4

	// Field (0) 'Contracts'
	size += len(c.Contracts) * 20

	return
}

// HashTreeRoot ssz hashes the ContractsContainer object
func (c *ContractsContainer) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(c)
}

// HashTreeRootWith ssz hashes the ContractsContainer object with a hasher
func (c *ContractsContainer) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (0) 'Contracts'
	{
		...
		numItems := uint64(len(c.Contracts))
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(1099511627776, numItems, 0))
		} else {
			hh.MerkleizeWithMixin(subIndx, numItems, ssz.CalculateLimit(1099511627776, numItems, 0))
		}
	}
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (11) 'LatestProcessedBlockActivities'
	dst = ssz.MarshalUint64(dst, b.LatestProcessedBlockActivities)

	// Field (12) 'TransactionsGasPerPeriod'
	dst = ssz.MarshalUint64(dst, b.TransactionsGasPerPeriod)

	// Field (13) 'TransactionsPerLatestEpoch'
	dst = ssz.MarshalUint64(dst, b.TransactionsPerLatestEpoch)

	// Field (14) 'NonStakersGasPerEpoch'
	dst = ssz.MarshalUint64(dst, b.NonStakersGasPerEpoch)

	// Field (15) 'NonStakersGasPerPeriod'
	dst = ssz.MarshalUint64(dst, b.NonStakersGasPerPeriod)

	// Offset (16) 'Validators'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Offset (18) 'Contracts'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(b.Contracts); ii++ {
		offset += 4
		offset += b.Contracts[ii].SizeSSZ()
	}

	// Offset (19) 'Activities'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.Activities) * 8
	...
	// Offset (22) 'PreviousEpochAttestations'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Offset (23) 'CurrentEpochAttestations'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (25) 'PreviousJustifiedCheckpoint'
	...
	// Field (26) 'CurrentJustifiedCheckpoint'
	...
	// Field (18) 'Contracts'
	if size := len(b.Contracts); size > 1099511627776 {
		err = ssz.ErrListTooBigFn("--.Contracts", size, 1099511627776)
		return
	}
	{
		offset = 4 * len(b.Contracts)
		for ii := 0; ii < len(b.Contracts); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += b.Contracts[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(b.Contracts); ii++ {
		if dst, err = b.Contracts[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}

	// Field (19) 'Activities'
	if size := len(b.Activities); size > 1099511627776 {
		err = ssz.ErrListTooBigFn("--.Activities", size, 1099511627776)
		return
	}
	for ii := 0; ii < len(b.Activities); ii++ {
		dst = ssz.MarshalUint64(dst, b.Activities[ii])
	}

	// Field (22) 'PreviousEpochAttestations'
	...
	// Field (23) 'CurrentEpochAttestations'
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o16, o17, o18, o19, o22, o23 uint64
	...
	// Field (11) 'LatestProcessedBlockActivities'
	b.LatestProcessedBlockActivities = ssz.UnmarshallUint64(buf[524552:524560])

	// Field (12) 'TransactionsGasPerPeriod'
	b.TransactionsGasPerPeriod = ssz.UnmarshallUint64(buf[524560:524568])

	// Field (13) 'TransactionsPerLatestEpoch'
	b.TransactionsPerLatestEpoch = ssz.UnmarshallUint64(buf[524568:524576])

	// Field (14) 'NonStakersGasPerEpoch'
	b.NonStakersGasPerEpoch = ssz.UnmarshallUint64(buf[524576:524584])

	// Field (15) 'NonStakersGasPerPeriod'
	b.NonStakersGasPerPeriod = ssz.UnmarshallUint64(buf[524584:524592])

	// Offset (16) 'Validators'
	if o16 = ssz.ReadOffset(buf[524592:524596]); o16 > size || o9 > o16 {
		return ssz.ErrOffset
	}

	// Offset (17) 'Balances'
	if o17 = ssz.ReadOffset(buf[524596:524600]); o17 > size || o16 > o17 {
		return ssz.ErrOffset
	}

	// Offset (18) 'Contracts'
	if o18 = ssz.ReadOffset(buf[524600:524604]); o18 > size || o17 > o18 {
		return ssz.ErrOffset
	}

	// Offset (19) 'Activities'
	if o19 = ssz.ReadOffset(buf[524604:524608]); o19 > size || o18 > o19 {
		return ssz.ErrOffset
	}
	...
	for ii := 0; ii < 65536; ii++ {
		if cap(b.RandaoMixes[ii]) == 0 {
			b.RandaoMixes[ii] = make([]byte, 0, len(buf[524608:2621760][ii*32:(ii+1)*32]))
		}
		b.RandaoMixes[ii] = append(b.RandaoMixes[ii], buf[524608:2621760][ii*32:(ii+1)*32]...)
	}

	// Field (21) 'Slashings'
	b.Slashings = ssz.ExtendUint64(b.Slashings, 8192)
	for ii := 0; ii < 8192; ii++ {
		b.Slashings[ii] = ssz.UnmarshallUint64(buf[2621760:2687296][ii*8 : (ii+1)*8])
	}

	// Offset (22) 'PreviousEpochAttestations'
	if o22 = ssz.ReadOffset(buf[2687296:2687300]); o22 > size || o19 > o22 {
		return ssz.ErrOffset
	}

	// Offset (23) 'CurrentEpochAttestations'
	if o23 = ssz.ReadOffset(buf[2687300:2687304]); o23 > size || o22 > o23 {
		return ssz.ErrOffset
	}

	// Field (24) 'JustificationBits'
	if cap(b.JustificationBits) == 0 {
		b.JustificationBits = make([]byte, 0, len(buf[2687304:2687305]))
	}
	b.JustificationBits = append(b.JustificationBits, buf[2687304:2687305]...)

	// Field (25) 'PreviousJustifiedCheckpoint'
	if b.PreviousJustifiedCheckpoint == nil {
		b.PreviousJustifiedCheckpoint = new(Checkpoint)
	}
	if err = b.PreviousJustifiedCheckpoint.UnmarshalSSZ(buf[2687305:2687345]); err != nil {
		return err
	}
	...
	if err = b.CurrentJustifiedCheckpoint.UnmarshalSSZ(buf[2687345:2687385]); err != nil {
		return err
	}
	...
	if err = b.FinalizedCheckpoint.UnmarshalSSZ(buf[2687385:2687425]); err != nil {
		return err
	}
	...
	// Field (18) 'Contracts'
	{
		...
		b.Contracts = make([]*ContractsContainer, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if b.Contracts[indx] == nil {
				b.Contracts[indx] = new(ContractsContainer)
			}
			if err = b.Contracts[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
	...
	// Field (19) 'Activities'
	{
		...
		b.Activities = ssz.ExtendUint64(b.Activities, num)
		for ii := 0; ii < num; ii++ {
			b.Activities[ii] = ssz.UnmarshallUint64(buf[ii*8 : (ii+1)*8])
		}
	}
...
func (b *BeaconState) SizeSSZ() (size int) {
	...
	for ii := 0; ii < len(b.Contracts); ii++ {
		size += 4
		size += b.Contracts[ii].SizeSSZ()
	}

	// Field (19) 'Activities'
	size += len(b.Activities) * 8
...
func (b *BeaconState) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (11) 'LatestProcessedBlockActivities'
	hh.PutUint64(b.LatestProcessedBlockActivities)

	// Field (12) 'TransactionsGasPerPeriod'
	hh.PutUint64(b.TransactionsGasPerPeriod)

	// Field (13) 'TransactionsPerLatestEpoch'
	hh.PutUint64(b.TransactionsPerLatestEpoch)

	// Field (14) 'NonStakersGasPerEpoch'
	hh.PutUint64(b.NonStakersGasPerEpoch)

	// Field (15) 'NonStakersGasPerPeriod'
	hh.PutUint64(b.NonStakersGasPerPeriod)
	...
	{
		subIndx := hh.Index()
		num := uint64(len(b.Contracts))
		if num > 1099511627776 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range b.Contracts {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
	...
	// Field (19) 'Activities'
	{
		...
		subIndx := hh.Index()
		for _, i := range b.Activities {
			hh.AppendUint64(i)
		}
		hh.FillUpTo32()

		numItems := uint64(len(b.Activities))
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(1099511627776, numItems, 8))
		} else {
			hh.MerkleizeWithMixin(subIndx, numItems, ssz.CalculateLimit(1099511627776, numItems, 8))
...
func (b *BeaconStateAltair) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (22) 'PreviousEpochParticipation'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PreviousEpochParticipation)

	// Offset (23) 'CurrentEpochParticipation'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Offset (28) 'InactivityScores'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.InactivityScores) * 8

	// Field (29) 'CurrentSyncCommittee'
	...
	// Field (22) 'PreviousEpochParticipation'
	...
	// Field (23) 'CurrentEpochParticipation'
...
func (b *BeaconStateAltair) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o16, o17, o18, o19, o22, o23, o28 uint64
	...
	// Offset (28) 'InactivityScores'
	if o28 = ssz.ReadOffset(buf[2687425:2687429]); o28 > size || o23 > o28 {
		return ssz.ErrOffset
	}
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2687429:2712053]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2712053:2736677]); err != nil {
		return err
	}
...
func (d *DepositMessage) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'DeployedContract'
	if cap(d.DeployedContract) == 0 {
		d.DeployedContract = make([]byte, 0, len(buf[88:108]))
	}
	d.DeployedContract = append(d.DeployedContract, buf[88:108]...)

	// Field (4) 'DeploymentNonce'
	d.DeploymentNonce = ssz.UnmarshallUint64(buf[108:116])
...
func (b *BeaconStateBellatrix) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (31) 'LatestExecutionPayloadHeader'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (31) 'LatestExecutionPayloadHeader'
...
func (b *BeaconStateBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o16, o17, o18, o19, o22, o23, o28, o31 uint64
...
// MarshalSSZ ssz marshals the BeaconStateFastexPhase1 object
func (b *BeaconStateFastexPhase1) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconStateFastexPhase1 object to a target array
func (b *BeaconStateFastexPhase1) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(2736697)
	...
	// Field (32) 'BaseFeePerEpoch'
	dst = ssz.MarshalUint64(dst, b.BaseFeePerEpoch)

	// Field (33) 'BaseFeePerPeriod'
	dst = ssz.MarshalUint64(dst, b.BaseFeePerPeriod)
...
// UnmarshalSSZ ssz unmarshals the BeaconStateFastexPhase1 object
func (b *BeaconStateFastexPhase1) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 2736697 {
		return ssz.ErrSize
	...
	// Field (32) 'BaseFeePerEpoch'
	b.BaseFeePerEpoch = ssz.UnmarshallUint64(buf[2736681:2736689])

	// Field (33) 'BaseFeePerPeriod'
	b.BaseFeePerPeriod = ssz.UnmarshallUint64(buf[2736689:2736697])
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconStateFastexPhase1 object
func (b *BeaconStateFastexPhase1) SizeSSZ() (size int) {
	size = 2736697
...
// HashTreeRoot ssz hashes the BeaconStateFastexPhase1 object
func (b *BeaconStateFastexPhase1) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconStateFastexPhase1 object with a hasher
func (b *BeaconStateFastexPhase1) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (32) 'BaseFeePerEpoch'
	hh.PutUint64(b.BaseFeePerEpoch)

	// Field (33) 'BaseFeePerPeriod'
	hh.PutUint64(b.BaseFeePerPeriod)
...
func (b *BeaconStateCapella) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o9, o16, o17, o18, o19, o22, o23, o28, o31, o36 uint64
	...
	// Field (34) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2736697:2736705])

	// Field (35) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2736705:2736713]))
...
func (v *Validator) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'EffectiveActivity'
	dst = ssz.MarshalUint64(dst, v.EffectiveActivity)
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'EffectiveActivity'
	v.EffectiveActivity = ssz.UnmarshallUint64(buf[88:96])

	// Field (4) 'Slashed'
	v.Slashed = ssz.UnmarshalBool(buf[96:97])

	// Field (5) 'ActivationEligibilityEpoch'
	v.ActivationEligibilityEpoch = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[97:105]))

	// Field (6) 'ActivationEpoch'
	v.ActivationEpoch = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[105:113]))

	// Field (7) 'ExitEpoch'
	v.ExitEpoch = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[113:121]))

	// Field (8) 'WithdrawableEpoch'
	v.WithdrawableEpoch = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[121:129]))
...
func (v *Validator) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (3) 'EffectiveActivity'
	hh.PutUint64(v.EffectiveActivity)
