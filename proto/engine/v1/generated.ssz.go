...
// Hash: c9d9022ac48953475ae75cad91f0f927c46addccc2eb7fa3cfb64aa2fba1c9f6
package enginev1
...
func (e *ExecutionPayloadCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (15) 'ActivitiesRoot'
	if size := len(e.ActivitiesRoot); size != 32 {
		err = ssz.ErrBytesLengthFn("--.ActivitiesRoot", size, 32)
		return
	}
	dst = append(dst, e.ActivitiesRoot...)

	// Field (16) 'TransactionsCount'
	dst = ssz.MarshalUint64(dst, e.TransactionsCount)
...
func (e *ExecutionPayloadCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (15) 'ActivitiesRoot'
	if cap(e.ActivitiesRoot) == 0 {
		e.ActivitiesRoot = make([]byte, 0, len(buf[512:544]))
	}
	e.ActivitiesRoot = append(e.ActivitiesRoot, buf[512:544]...)

	// Field (16) 'TransactionsCount'
	e.TransactionsCount = ssz.UnmarshallUint64(buf[544:552])
...
func (e *ExecutionPayloadCapella) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	hh.PutBytes(e.ActivitiesRoot)

	// Field (16) 'TransactionsCount'
	hh.PutUint64(e.TransactionsCount)
...
func (e *ExecutionPayloadDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (17) 'BlobGasUsed'
	dst = ssz.MarshalUint64(dst, e.BlobGasUsed)

	// Field (18) 'ExcessBlobGas'
...
func (e *ExecutionPayloadDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (17) 'BlobGasUsed'
	e.BlobGasUsed = ssz.UnmarshallUint64(buf[552:560])

	// Field (18) 'ExcessBlobGas'
	e.ExcessBlobGas = ssz.UnmarshallUint64(buf[560:568])
...
func (e *ExecutionPayloadHeaderCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (15) 'ActivitiesRoot'
	if cap(e.ActivitiesRoot) == 0 {
		e.ActivitiesRoot = make([]byte, 0, len(buf[568:600]))
	}
	e.ActivitiesRoot = append(e.ActivitiesRoot, buf[568:600]...)

	// Field (16) 'TransactionsCount'
	e.TransactionsCount = ssz.UnmarshallUint64(buf[600:608])
...
func (e *ExecutionPayloadHeaderDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (17) 'BlobGasUsed'
	e.BlobGasUsed = ssz.UnmarshallUint64(buf[608:616])

	// Field (18) 'ExcessBlobGas'
	e.ExcessBlobGas = ssz.UnmarshallUint64(buf[616:624])
