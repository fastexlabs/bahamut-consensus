...
type ExecutionPayloadCapellaJSON struct {
	...
	StateRoot         *common.Hash    `json:"stateRoot"`
	ReceiptsRoot      *common.Hash    `json:"receiptsRoot"`
	ActivitiesRoot    *common.Hash    `json:"activitiesRoot"`
	TransactionsCount *hexutil.Uint64 `json:"transactionsCount"`
	LogsBloom         *hexutil.Bytes  `json:"logsBloom"`
	PrevRandao        *common.Hash    `json:"prevRandao"`
	BlockNumber       *hexutil.Uint64 `json:"blockNumber"`
	GasLimit          *hexutil.Uint64 `json:"gasLimit"`
...
func (e *ExecutionPayloadCapella) MarshalJSON() ([]byte, error) {
	...
	sRoot := common.BytesToHash(e.StateRoot)
	recRoot := common.BytesToHash(e.ReceiptsRoot)
	actRoot := common.BytesToHash(e.ActivitiesRoot)
	transactionsCount := hexutil.Uint64(e.TransactionsCount)
	prevRan := common.BytesToHash(e.PrevRandao)
	bHash := common.BytesToHash(e.BlockHash)
	blockNum := hexutil.Uint64(e.BlockNumber)
	gasLimit := hexutil.Uint64(e.GasLimit)
...
func (e *ExecutionPayloadCapellaWithValue) UnmarshalJSON(enc []byte) error {
	...
	// todo unit act
	if dec.ExecutionPayload.ActivitiesRoot == nil {
		return errors.New("missing required field 'activitiesRoot' for ExecutableDataV1")
	}
	if dec.ExecutionPayload.TransactionsCount == nil {
		return errors.New("missing required field 'transactionsCount' for ExecutableDataV1")
	}
	...
	*e = ExecutionPayloadCapellaWithValue{Payload: &ExecutionPayloadCapella{}}
	...
	e.Payload.ActivitiesRoot = dec.ExecutionPayload.ActivitiesRoot.Bytes()
	e.Payload.TransactionsCount = uint64(*dec.ExecutionPayload.TransactionsCount)
